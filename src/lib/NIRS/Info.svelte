<script>
    ...
    async function loadSnirf() {
        ...
        if (path) {
            await invoke("import_snirf", { path });
        }
    }
        ...
        <div class="panel-scroll">
            ...
            <section class="card">
                ...
                <div class="grid-2col">
                    ...
                    <div class="kv">
                        ...
                        <span class="value"
                            >{summary.timepoints.toLocaleString()}</span
                        >
                    </div>
                </div>
            </section>
                        ...
                        {#each summary.events as ev}
                            <div class="event-row">
                                ...
                                <span class="event-count"
                                    >{ev.marker_count} marker{ev.marker_count !==
                                    1
                                        ? "s"
                                        : ""}</span
                                >
            ...
            <section class="card">
                ...
                <div class="row single">
                    ...
                    {:else}
                        <span class="value"
                            >{summary.aux_count} signal{summary.aux_count !== 1
                                ? "s"
                                : ""}</span
                        >
                    {/if}
